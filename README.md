...
> :warning: Disclaimer: we are not affiliated with Google in any way nor Google has endorsed the site in any way other than approve the OAuth use.
...
[![Open in Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.svg)](https://accounts.google.com/AccountChooser?continue=https://shell.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/casson-projects-2020/fable-facet&cloudshell_tutorial=tutorial_entry.md&show=terminal&tutorial_reset=true)
...
* **Purpose** The system has solely the purpose of writing and publishing texts 
