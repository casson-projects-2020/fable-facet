...
This is a "Open In Google Cloud Shell" repo - it will create in a Google Cloud Platform (GCP) account the infrastructure the site 
[Fable Facet](https://fablefacet.com/ffacet.mesis.html) needs to allow a user to use his own 1000 Gemini API free calls (generously given to all by Google) to generate AI-driven stories. 
